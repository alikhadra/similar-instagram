            ...
            <div class="col-span-3">
                ...
                <div class="col-span-2 bg-white flex flex-col">
                    ...
                    <div class="flex flex-col" id="sec3">
                        ...
                        <div class="border-b border-solid border-gray-300 ps-4 pb-1">
                    ...
                    <div class="p-4" id="sec4">
                        @if(Auth::check())
                            <form action="/comments" method="POST" autocomplete="off">
                                ...
                                <input type="text" class="w-full outline-none border-none p-1 me-3" id="comment{{$post->id}}"
                                placeholder="{{__('Add comment')}}" name="comment" autofocus>
                                <input type="hidden" name="post_id" value="{{$post->id}}">
                                <button class="text-blue-500 font-semibold hover:text-blue-700" type="submit">
                                    {{__('Post')}}
                                </button>
                            </div>
                            </form>
