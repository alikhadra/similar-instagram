                   ...
                   <div class="grid grid-rows-2">
                       ...
                       <div>
                           <ul class="flex flex-row mb-5">
                               ...
                               <li class="me-10"><a href="{{ route('followers')}}"><span class="font-semibold me-1">
                                    {{ $profile->followers()->count() }}
                                </span>{{__('followers')}}</a></li>
                               <li class="me-10"><a href="{{ route('following')}}"><span class="font-semibold me-1">
